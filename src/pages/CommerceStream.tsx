...
import { ArrowLeft, BookOpen, TrendingUp, Users, Award, Clock, Play } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Explore the world of business and finance through this comprehensive video
            </CardDescription>
          </CardHeader>
          <CardContent>
